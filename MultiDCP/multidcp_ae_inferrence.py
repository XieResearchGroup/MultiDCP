...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_file', default="/raid/home/yoyowu/MultiDCP/MultiDCP_data/data/pert_transcriptom/random_train1.csv")
    ...
    parser.add_argument('--cell_ge_file', help='the file which used to map cell line to gene expression file', default= "/raid/home/yoyowu/MultiDCP/data/adjusted_ccle_tcga_ad_tpm_log2.csv")
    parser.add_argument('--max_epoch', type = int, default = 1)
    parser.add_argument('--ground_truth_for_testset', help = "the file directory to save the predicted test dataframe", default="/raid/home/yoyowu/MultiDCP/MultiDCP_data/data/predictions/0522_ground_truth_for_corr_check.csv")
    parser.add_argument('--predicted_result_for_testset', help = "the file directory to save the predicted test dataframe", default="/raid/home/yoyowu/MultiDCP/MultiDCP_data/data/predictions/0720_test_reproduce.csv")
    parser.add_argument('--pretrained_model', type=str, default="/raid/home/yoyowu/MultiDCP/saved_models/1013rand1.pt", help='add pretrained model path here if using pretrained model')
