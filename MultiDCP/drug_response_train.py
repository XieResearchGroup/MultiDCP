...
if __name__ == '__main__':
    ...
    parser.add_argument('--hill_test_file', type = str,default =  'MultiDCP_data/data/ehill_data/high_confident_data_test.csv')
    ...
    parser.add_argument('--trained_model_path',type = str,default="/raid/home/yoyowu/MultiDCP/saved_models/1008_pre_cell_hc2andAll.pt")
    ...
    if args.trained_model_path is not None:
        model.multidcp.encoder.load_state_dict(torch.load(args.trained_model_path))
