...
if __name__ == '__main__':
    ...
    parser.add_argument('--predicted_result_for_testset', default= None, help = "the file directory to save the predicted test dataframe")
    parser.add_argument('--hidden_repr_result_for_testset', default= None, help = "the file directory to save the test data hidden representation dataframe")
